    ...
    return (
        <div className='pb-16'>
            ...
            <div className='text-center py-9'>
                ...
                <p className='px-4  text-xl mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20"'>Indian Chef Take-Out Express Motto is to bring to your home the aroma of India's rich culture, flavor, and culinary heritage. The eatery features selections of Indian meals to choose from and is the best choice for tasty Indian dishes. They come up with great and flavorful meals at worth-able prices, with outstanding experiences for patrons of all ages and historic towns like Umatilla. Whether you're craving a quick bite or looking to treat yourself to a delicious meal, you can order your Indian Chef Take-Out Express favorites for takeaway or delivery, available on all platforms Uber Eats, Doordash, Grubhub and Toast.</p>
            </div>
